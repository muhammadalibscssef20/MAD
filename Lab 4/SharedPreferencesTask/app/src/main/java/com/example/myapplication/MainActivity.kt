    ...
    Column(
        ...
        Row(
            ...
            Button(onClick = {
                ...
                Toast.makeText(context, "Data stored in shared preferences", Toast.LENGTH_SHORT).show()
            }) {
                Text(text = "Store")
            }
            Button(onClick = {
                Toast.makeText(context, "Reading data from shared preferences", Toast.LENGTH_SHORT).show()
